...
#     od_graph_def = tf.compat.v1.GraphDef()                          #CHANGED ###############
#     # with tf.gfile.GFile(PATH_TO_CKPT, 'rb') as fid:
#     with tf.compat.v2.io.gfile.GFile(PATH_TO_CKPT, 'rb') as fid:            #CHANGED#################
...
#         self.sess = tf.compat.v1.Session(graph=detection_graph,config=config)           #CHANGED##############
...
import keras                    ######################ADDED###################
from keras_preprocessing import image   #################ADDED##############
...
import keras.backend as KTF           #######################CHANGED#################

GPU_FRACTION = 0.2

CAMERA_TOPIC = "/camera/color/image_raw2"
...
def main(args):
  ...
  rospy.init_node('detector_node')
  global CAMERA_TOPIC
  CAMERA_TOPIC = rospy.get_param('~camera_topic', '/camera/color/image_raw2')        ###################ADDED 1.0 ##############
