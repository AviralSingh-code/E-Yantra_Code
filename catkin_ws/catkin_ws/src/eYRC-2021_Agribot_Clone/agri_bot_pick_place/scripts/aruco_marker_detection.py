...
def main(args):
    ...
    # image_sub = rospy.Subscriber("/camera/color/image_raw2", Image, callback)               #######################ADDED#####################
    # tfBuffer = tf2_ros.Buffer()                                                         #for setting the buffer
    # listener = tf2_ros.TransformListener(tfBuffer) 
    # while not rospy.is_shutdown():
    #     try:
    #         trans = tfBuffer.lookup_transform('sjcam_link', 'aruco17', rospy.Time(0))
    #     except (tf2_ros.LookupException, tf2_ros.ConnectivityException, tf2_ros.ExtrapolationException):
    #         continue
    #     rospy.loginfo("#################################")
    #     rospy.loginfo(trans.transform.translation.x)
    #     rospy.loginfo(trans.transform.translation.y)
    #     rospy.loginfo(trans.transform.translation.z)
    #     rospy.loginfo("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
    try:
        rospy.spin()
