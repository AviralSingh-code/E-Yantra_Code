...
def control():          #the control function

    rospy.init_node('control_ebot')             #initializing node 
    ...
    velocity_msg = Twist()               #defining vel of type twist
    ...
    rate.sleep()                        #rate.sleep() is used to keep the node alive with the current rate defined above



if __name__=='__main__':                #main method
    try:
        control()               #calling the control function
    except rospy.ROSInterruptException:         #to stop is the node is terminated
        pass
